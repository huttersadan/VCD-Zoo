...
from vcd_utils.vcd_sample import evolve_vcd_sampling_llava,evolve_vcd_sampling
...
with accelerator.split_between_processes(rs_ls) as single_gpu_question_ls:
    ...
    for inst in tqdm.tqdm(single_gpu_question_ls):
        ...
        response_records.append({
            "benchmark": "mme",
            "method": "original" if args.original else "AVISC",
...
# gather main process
write_to_file =  gather_object(write_to_file)
response_records = gather_object(response_records)

if accelerator.is_main_process:
    type_method = "original" if args.original else "AVISC"
